  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          className="bg-[#CCD6F6] p-2 placeholder-[#0a192f]"
          type="text"
        ...
        ></textarea>
        <button className="text-white border-2 hover:bg-[#cf4f4f] hover:border-[#cf4f4f] px-8 py-3 my-8 mx-auto flex items-center">
          Submit!
        </button>
      </form>
    </div>
